 ...
 *
 * Die eigentliche Versionserzeugung (neue question-Zeile + neue
 * question_versions-Zeile an derselben questionbankentryid, neue Antworten,
 * idnumber-Erhalt) uebernimmt local_coursepilot\mc_question_version::update()
 * ueber Moodles question_type::save_question(). Die alte question-Zeile
 * bleibt unangetastet, damit bestehende Quiz-Attempts gueltig bleiben.
 *
...
class update_mc_question extends external_api {
    ...
    public static function execute(
        ...
        // Bestehende Fragenbank-Entry finden, Kontext daraus aufloesen,
        // Capability pruefen.
        ...
        // questionbankentryid ueber Moodles Core-API (ADR-0001). Die alte
        // question-Zeile bleibt fuer bestehende Quiz-Attempts unangetastet.
